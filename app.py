...
#         # 1. Tree-based Model (Random Forest / Decision Tree)
#         if hasattr(estimator, 'feature_importances_'):
#             importances = estimator.feature_importances_

#         # 2. Linear / Logistic Regression / SVM
...
# Main Navigation Tabs (৩টি ট্যাব তৈরি করা হলো)
...
with tab2:
    ...
    try:
        ...
        st.error("Feature Importance হিসাব করার সময় সমস্যা হয়েছে।")
        st.code(str(e))
